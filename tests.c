...
void tests(void) {
  ...
  test("c=d=7.27", 7.27);
  test("c=a", 2.23);
  test("a=b=c=d=999", 999);
  test("a", 999);
  test("b", 999);
  test("c", 999);
  test("d", 999);
  test("b=c=1+2*3*4+(5/6)", 1+2*3*4+(5.00/6.00));
  test("b", 1+2*3*4+(5.00/6.00));
  test("c", 1+2*3*4+(5.00/6.00));
  test("a=5-((-1+1)+(b=c=1+2*3*4+(d=5/6)-7))", 5-((-1+1)+(1+2*3*4+(5.00/6.00)-7)));
	test("a", 5-((-1+1)+(1+2*3*4+(5.00/6.00)-7)));
